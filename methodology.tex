...
\subsection{Compressed Row/Column Storage}
 ...
 Using the example data given in Table \ref{tab:matrixmarket} and Figure \ref{fig:exampleMatrix} we can do CRS representation as shown in Table \ref{tab:compressed}.
